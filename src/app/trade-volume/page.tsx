      ...
      <div className="container px-2 py-4 md:px-4 md:py-8">
        ...
        <div className="mb-4 grid gap-4 md:mb-8 md:grid-cols-3 md:gap-6">
          <div className="md:col-span-2">
            <div className="border-border/40 bg-card rounded-lg border p-3 shadow-sm md:p-6">
              <h2 className="mb-3 text-lg font-semibold tracking-tight md:mb-4 md:text-xl">
                About This Chart
              </h2>
              <p className="text-muted-foreground mb-3 text-sm md:mb-4 md:text-base">
              ...
              <div className="bg-card/50 rounded-md p-3 md:p-4">
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="bg-card/50 rounded-md p-3 md:p-4">
                  <div className="mb-2 flex items-center">
                    <MdShowChart className="text-primary mr-2 h-4 w-4 md:h-5 md:w-5" />
                    <h3 className="text-sm font-medium md:text-base">
                      Orderbook Volume
                    </h3>
                  </div>
                  <p className="text-muted-foreground mb-2 text-xs md:mb-3 md:text-sm">
                    View orderbook depth for a different market perspective
                  </p>
                  <Link
                    href="/realtime-volume"
                    className="text-primary inline-flex items-center text-xs font-medium md:text-sm"
                  >
                ...
                <div className="bg-card/50 rounded-md p-3 md:p-4">
                  <div className="mb-2 flex items-center">
                    <MdStorage className="text-primary mr-2 h-4 w-4 md:h-5 md:w-5" />
                    <h3 className="text-sm font-medium md:text-base">
                      Historical Data
                    </h3>
                  </div>
        ...
        {/* Chart Component */}
        <div className="border-border/40 bg-card rounded-lg border p-2 shadow-sm md:p-6">
